...
- Im lokalen URL-Testmodus (`?test=1`) zeigt die Bundesliga-Nutzeransicht einen Variantenumschalter für A, Design, C und D. Der Umschalter erhält den aktuellen Bereich und wechselt nur die passende Hash-Familie; produktive Nutzer sehen ihn nicht.
